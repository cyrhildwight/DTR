...
<head>
    ...
    <style>
        ...
        /* Colors */
        .date { color: #3b82f6; font-weight: bold; }
        .time-in { color: #059669; font-weight: bold; }
        .time-out { color: #dc2626; font-weight: bold; }
        .hours { color: #7c3aed; font-weight: bold; }
        ...
        .status-timein { background: #fef3c7; color: #92400e; }
        .status-norecord { background: #fee2e2; color: #991b1b; }
        ...
        .trainee-info { margin-bottom: 25px; }
        .info-table, .allowance-table {
            width: 100%;
            border-collapse: collapse;
        }
        ...
        .info-table th, .allowance-table th {
            background: #f8f9fa;
            font-weight: bold;
            color: #000;
        }
        ...
        .allowance-summary { margin-bottom: 25px; }
        .allowance-summary h3 { margin: 0 0 10px 0; font-size: 14px; color: #000; }
        .total-allowance { text-align: right; font-size: 14px; font-weight: bold; margin: 15px 0; color: #000; }
        .acknowledgment { margin: 25px 0; font-size: 12px; line-height: 1.5; }
...
<div class="page-2">
    <div class="payslip-header">
        <h1>LIMEHILLS</h1>
        <div class="payslip-title">OJT PAYSLIP</div>
    </div>
