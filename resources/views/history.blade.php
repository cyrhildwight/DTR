...
<body class="min-h-screen bg-gradient-to-br from-blue-950 via-gray-900 to-slate-900 text-white font-sans">
  ...
  <div class="relative peer">
    ...
    <div id="modal"
      class="modal hidden px-0  fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto flex items-end lg:items-start max-h-screen">

      <div
        class="max-w-[1000px] w-full mx-auto bg-zinc-900 p-6 rounded-t-lg lg:rounded-lg shadow-md relative lg:mt-4 overflow-y-auto max-h-full">

        <button
          class="modal-close absolute top-2 right-2 bg-yellow-500 text-black rounded-full w-[30px] h-[30px] shadow">
         X
        </button>

        <div class="modal-content">
          <img src="" id="image_placeholder" class="w-full h-auto rounded-lg shadow-lg"
            alt="Captured Image">
        </div>
      </div>
